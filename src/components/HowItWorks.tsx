      ...
      <div className="max-w-6xl mx-auto px-5">
        ...
        <div className={`mb-14 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-ink leading-tight">
            3 Langkah.<br />
            <span className="italic text-brand">Langsung Jalan.</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {steps.map((s, i) => (
            <div
              key={s.num}
              className={`rounded-3xl p-8 flex flex-col justify-between min-h-[280px] transition-all duration-700 hover:-translate-y-2 hover:shadow-xl ${
            ...
            >
              <div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: s.fg, opacity: 0.65 }}>
                  {s.desc}
                </p>
              </div>
        ...
        >
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-brand text-white font-bold px-8 py-4 rounded-full text-sm hover:bg-brand-dark hover:scale-105 transition-all shadow-lg shadow-brand/25"
          >
          ...
          <a
            ...
            target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-3 bg-white border-2 border-brand text-brand font-bold px-8 py-4 rounded-full text-sm hover:bg-chalk-dark transition-all"
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
